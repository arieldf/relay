...
/***/ function(module, exports, __webpack_require__) {
	...
	function isRelayContext(context) {
	  return typeof context === 'object' && context !== null && !Array.isArray(context) && __webpack_require__(32)(context.environment) && __webpack_require__(51)(context.variables);
	}
	...
	function buildCompatContainer(ComponentClass, fragmentSpec, createContainerWithFragments) {
	  ...
	  function ContainerConstructor(props, context) {
	    if (Container == null || context.relay.environment !== environment) {
	      ...
	      __webpack_require__(44).proxyMethods(Container, ComponentClass);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getClassicNode(taggedNode) {
	  ...
	  if (concreteNode == null) {
	    ...
	    concreteNode = fn(__webpack_require__(46));
	...
	function findConnectionMetadata(fragments) {
	  ...
	  for (var _fragmentName in fragments) {
	    ...
	    if (fragment.metadata !== undefined) {
	      __webpack_require__(7)(connectionMetadata, 'ReactRelayPaginationContainer: A @connection directive must be present.');
	    }
